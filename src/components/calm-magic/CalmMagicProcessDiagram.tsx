      ...
      <CardContent>
        <div className="overflow-x-auto">
          <svg viewBox="0 0 1200 800" className="w-full h-auto">
            ...
            <text x="600" y="670" textAnchor="middle" className="text-xs fill-slate-600">Data-driven insights inform future garden selections and emotional state calibrations</text>
