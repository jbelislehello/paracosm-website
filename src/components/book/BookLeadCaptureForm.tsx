    ...
    return (
      <form onSubmit={onSubmit} className="space-y-3">
        ...
        <input
          ...
          aria-hidden
        />
        <Button type="submit" disabled={submitting} className="w-full bg-foreground text-background hover:bg-foreground/90 text-xs font-semibold uppercase tracking-[0.2em] rounded-none">
