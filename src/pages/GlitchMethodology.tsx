import { Search, Waves, Sparkles, ArrowRight, Clock, Users, Zap, FileText, Code, Megaphone, Mic, Eye, ExternalLink, Lightbulb, Box, Palette } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="max-w-5xl mx-auto">
          ...
          <h3 className="text-center text-xl font-semibold mb-6 text-white/70">Educational Design Platforms</h3>
