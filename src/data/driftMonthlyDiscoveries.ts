...
export const driftMonthlyDiscoveries: DriftMonthEntry[] = [
  ...
  },
  {
    ...
    books: [
      ...
      { title: "HOLO 1", author: "Philip Beesley, DAM GALLERY, Derivative, Eno Henze, Raquel Meyers, David O'Reilly, Chris O'Shea, Jer Thorp, Semiconductor, Zimoun", description: "A 200+ page periodical on emerging trajectories in art, science, and technology, featuring encounters with leading artists and studios.", category: "Sensory Rooms", axis: "love", amazonUrl: "" },
      { title: "HOLO 2: IF/THEN", author: "Tina Amiri, Ryoichi Kurokawa, Jürg Lehni, Rafael Lozano-Hemmer, Vera Molnar, Katie Paterson, Tale of Tales", description: "A themed volume exploring chance, uncertainty, and the search for true randomness, with essays and works by multiple contributors.", category: "Sensory Rooms", axis: "love", amazonUrl: "" },
      { title: "Non-Linear Leadership", author: "Roman", description: "A publication on non-linear approaches to leadership practice.", category: "Inquiry and Practices", axis: "love", amazonUrl: "" },
      { title: "Issue 01: Beginnings", author: "Unknown", description: "A magazine or zine exploring the theme of beginnings.", category: "Telling Stories", axis: "love", amazonUrl: "" },
      { title: "Magazine Digi — Hertz 2025 (No 13)", author: "Unknown", description: "Issue 13 of the Digi magazine, themed around Hertz 2025.", category: "Connected Life", axis: "love", amazonUrl: "" },
      { title: "Guide 2025–2026 des restaurants de Montréal", author: "Unknown", description: "A curated restaurant guide for Montréal, 2025–2026 edition.", category: "Tangible Play", axis: "love", amazonUrl: "" },
      { title: "Originals: How Non-Conformists Move the World", author: "Adam Grant", description: "Examines how people champion new ideas, resist conformity and groupthink, and drive change.", category: "Embodied Cognition", axis: "love", amazonUrl: "https://www.amazon.ca/Originals-How-Non-Conformists-Move-World/dp/014312885X" },
      { title: "The Order of Time", author: "Carlo Rovelli", description: "A popular-science exploration of what modern physics suggests about the nature of time.", category: "Narratives", axis: "love", amazonUrl: "https://www.amazon.ca/Order-Time-Carlo-Rovelli/dp/073521610X" },
    ],
    videos: [
