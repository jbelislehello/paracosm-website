# Tile Matrix Structure Reference

## Overview
The Glitch Compass uses an 8×8 tile matrix organized into distinct vertical stages and horizontal dimensions.

## Vertical Structure (8 Rows)

### Stage 1: AGENDAS (Rows 1-3)
Contains the **MAG** foundation of MAGIC:
- **Row 1: M** - Mindsets
- **Row 2: A** - Agilities  
...
- **LOVE** - Initial signals and recognition
- **MAGIC** - Story and patterns
- **CALM** - Requirements and constraints
- **OPEN** - Ontology and workflow
